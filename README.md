...
- 고대 로마의 시인 유벨날리스는 강인한 정신이 나약한 육체를 지탱한다고 말하였습니다. 그렇다면, 나약한 정신은 강인한 육체를 병들게 한다는 의미이기도 합니다. 제가 명언 웹을 만든 이유도 이와 일맥상통합니다. 강인한 정신으로 무장하여 나약한 육체를 지탱하고, 더 나아가 강인한 육체로 탈바꿈 할 수 있는 환경을 만들어 나가도록 스스로를 독려하고 강화해나갈 수 있는 기반을 구축해 나가는 것이 해당 프로젝트가 가지는 방향성입니다.
...
- ※ 현재 사이트 배포 이후 발견된 문제가 있었는데 지금은 거의 해결되었고, 실제 배포에서 반영은 추가적인 개선 이후 29일 이내에 이루어질 예정입니다.
