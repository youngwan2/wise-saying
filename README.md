...
- 고대 로마의 시인 유벨날리스는 강인한 정신이 나약한 육체를 지탱한다고 말하였습니다. 그렇다면, 나약한 정신은 강인한 육체를 병들게 한다는 의미이기도 합니다. 제가 명언 웹을 만든 이유도 이와 일맥상통합니다. 나약한 정신을 강인하게 단련해 나갈 수 있도록 차분한 환경을 구성하여 자신만의 시간에 집중할 수 있는 환경을 만들어 나가는 것이 해당 프로젝트가 추구하는 방향성 입니다. 
