...
export default function UserPage() {
  ...
  if (!categories) return <ReplaceMessageCard childern='데이터를 불러오는 중 문제가 발생하였습니다. 나중에 다시시도 해주세요.' />
  if (categories.length<1) return <ReplaceMessageCard childern='데이터를 불러오는 중입니다.' />
  return (
    <>
