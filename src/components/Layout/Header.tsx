...
export default function Header() {
  return (
    <>
      <header className="shadow-[inset_-2px_-2px_5px_rgba(0,0,0,0.5)] top-0 fixed z-20 max-h-[45px] min-h-[50px] mb-[5px] mx-auto max-w-[1700px] flex justify-between bg-[#fcfbfb] p-[10px]  w-[100%] px-[10px] items-center rounded-b-[10px] left-[50%] translate-x-[-50%]">
