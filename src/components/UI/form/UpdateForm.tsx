...
import { updateUserPost } from '@/api/user/patch'
  ...
  return (
    <>
      ...
      >
        ...
        <UpdateSubjectInput post={post} name="category" />
        <br />
        {/* 내용 */}
        <UpdateContentInput post={post} name="content" />
        <br />
        {/* 작성자(유저작명) */}
        <UpdateAuthorInput post={post} name="author" />
        <br />
