    ...
    <>
      ...
      <article>
        <h2 className=" flex items-center text-[1.2em] mt-[1.25em] pb-[0.25em] text-[white]">
          ...
          <p className="ml-[0.5em]">글자 외곽선 굵기</p>
        </h2>
      ...
      <article className="mb-[1em]">
        <h2 className=" flex items-center text-[1.2em] mt-[1.25em] pb-[0.25em] text-[white]">
          <HiPaintBrush color="white" />{' '}
          <p className="ml-[0.5em]">글자 외곽선 색</p>
        </h2>
        {/* 컬러 픽커 */}
        <article
          className={`${
        ...
        <div className="flex items-center">
          <div
            className="h-[32px] p-[5px] rounded-[0.5em] shadow-[0_0px_0px_1px_black] w-[195px] text-center bg-white"
            ref={divRef}
          ></div>
          <button
