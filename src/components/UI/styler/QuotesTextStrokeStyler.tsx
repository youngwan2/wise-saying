            ...
            <div className="mb-[10px] flex">
                ...
                <article>
                    ...
                    <article className="flex">
                        <input min={0} type="number" className="text-center p-[1px] w-[160px]" placeholder="Default: 1px" onChange={(e) => {
                ...
                <article className="ml-[0.9em]">
                    ...
                    <div className="flex items-center">
                        <div className="w-[98px] h-[5px] bg-[white]" ref={divRef} ></div>
                        <button className='bg-[#d4d3d3] ml-[6px] px-[5.3px] py-[1px] ' onClick={() => setDisplayState(!displayState)}>변경</button>
                    </div>
                </article>
            </div>
    )
