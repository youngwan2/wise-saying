...
export default function TextSizeStyler({
  ...
  return (
    <article className='max-w-[150px] ml-[0.51em] px-[10px] rounded-sm flex flex-col items-center relative  border'>
      ...
      <TextSizeSelector textSizes={textSizes} isShowSelector={isShowSelector} onClickTextSizeSelect={onClickTextSizeSelect} onClickDisplaySelect={onClickSetDisplaySelect} />
    </article>
  )
}
