...
export default function BookmarkModalButton() {
  ...
  return (
    ...
    >
      <span aria-label='북마크 아이콘' className=" rounded-[1em] flex flex-col items-center ">
        <span aria-label='북마크 아이콘' className="bg-[#fe7c7c] px-[10px] rounded-[1em] mb-[-15px] z-[1] text-white">
          {count}
        </span>
        <HiOutlineBookmark aria-label='북마크 아이콘' className={'text-[25px] '} />
      </span>
    </button>
  )
}
