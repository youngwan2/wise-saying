  ...
  return (
    <div className="mx-auto my-[5px]">
      ...
      <input
        ...
        id="nickname"
        name="nickname"
        className="shadow-[0_0_0_2px_white] bg-[transparent]  rounded-[2px] border-gray min-w-[200px] max-w-[250px] w-full p-[6px] placeholder:text-[gray] bg-[#e2dfdf] focus:outline-none text-white "
        ref={nicknameRef}
        type="text"
        maxLength={6}
