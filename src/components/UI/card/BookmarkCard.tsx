...
export default function BookmarkCard({key, bookmark }: PropsType) {


    return (
        <ul className="flex flex-col bg-[white] max-w-[1200px] w-full p-[1em] pt-[2em] m-[5px] rounded-[10px] subpixel-antialiased  relative" key={key}>
